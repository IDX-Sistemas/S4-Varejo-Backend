...
namespace IdxSistemas.AppServer.Migrations
{
    ...
    [Migration("20191229145944_CatalogGroupTile")]
    partial class CatalogGroupTile
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IdxSistemas.Models.Catalog", b =>
                {
                    b.Property<long>("RowId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("sql_rowid")
            ...
            modelBuilder.Entity("IdxSistemas.Models.CatalogItem", b =>
                {
                    b.Property<long>("RowId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("sql_rowid")
                    ...
                    b.Property<long>("CatalogRowId");

                    b.Property<string>("RowDeleted")
                        .HasColumnName("sql_deleted");

                    b.Property<long>("TileRowId");

                    b.HasKey("RowId");

                    b.HasIndex("CatalogRowId")
                        .IsUnique();

                    b.HasIndex("TileRowId")
                        .IsUnique();
            ...
            modelBuilder.Entity("IdxSistemas.Models.Group", b =>
                {
                    b.Property<long>("RowId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("sql_rowid")
                    ...
                    b.Property<string>("isGroupLocked")
                        .HasColumnName("IsGroupLocked");

                    b.Property<string>("isPreset")
            ...
            modelBuilder.Entity("IdxSistemas.Models.GroupItem", b =>
                {
                    b.Property<long>("RowId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("sql_rowid")
            ...
            modelBuilder.Entity("IdxSistemas.Models.Tile", b =>
                {
                    b.Property<long>("RowId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("sql_rowid")
            ...
            modelBuilder.Entity("IdxSistemas.Models.TileProperties", b =>
                {
                    b.Property<long>("RowId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("sql_rowid")
            ...
            modelBuilder.Entity("IdxSistemas.Models.CatalogItem", b =>
                {
                    b.HasOne("IdxSistemas.Models.Catalog", "Catalog")
                        .WithOne()
                        .HasForeignKey("IdxSistemas.Models.CatalogItem", "CatalogRowId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("IdxSistemas.Models.Tile", "Tile")
                        .WithOne()
                        .HasForeignKey("IdxSistemas.Models.CatalogItem", "TileRowId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("IdxSistemas.Models.GroupItem", b =>
                {
                    b.HasOne("IdxSistemas.Models.Group", "Group")
                        .WithOne()
                        .HasForeignKey("IdxSistemas.Models.GroupItem", "GroupRowId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("IdxSistemas.Models.Tile", "Tile")
                        .WithMany()
                        .HasForeignKey("TileRowId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
