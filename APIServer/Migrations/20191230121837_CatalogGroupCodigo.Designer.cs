...
namespace IdxSistemas.AppServer.Migrations
{
    ...
    [Migration("20191230121837_CatalogGroupCodigo")]
    partial class CatalogGroupCodigo
    {
            ...
            modelBuilder.Entity("IdxSistemas.Models.CatalogItem", b =>
                {
                    ...
                    b.Property<string>("CatalogCodigo")
                        .IsRequired()
                        .HasMaxLength(50);
                    ...
                    b.Property<string>("TileCodigo")
                        .IsRequired()
                        .HasMaxLength(50);

                    b.HasKey("RowId");

                    b.HasIndex("CatalogCodigo");

                    b.HasIndex("TileCodigo");
            ...
            modelBuilder.Entity("IdxSistemas.Models.CatalogItem", b =>
                {
                    b.HasOne("IdxSistemas.Models.Catalog", "Catalog")
                        .WithMany()
                        .HasForeignKey("CatalogCodigo")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("IdxSistemas.Models.Tile", "Tile")
                        .WithMany()
                        .HasForeignKey("TileCodigo")
                        .OnDelete(DeleteBehavior.Cascade);
                });
